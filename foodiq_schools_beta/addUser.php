...
if (isset($userAdd)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3 class='text-center'>Dodaj novega uporabnika</h3>
        </div>
        <div class="cad-body">
            ...
            <form class="" action="" method="post">
                ...
                <div class="form-group">
                  <div class="form-group">
                    <label for="sel1">Izberite vlogo</label>
                ...
                <div class="form-group">
                  <button type="submit" name="addUser" class="btn btn-success">Registracija</button>
                </div>
